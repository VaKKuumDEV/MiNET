...
namespace MiNET.Blocks
{
	...
	{
		public string[] nameValues = { "cobblestone", "mossy_cobblestone", "granite", "diorite", "andesite", "sandstone", "red_sandstone", "stone_brick", "mossy_stone_brick", "brick", "nether_brick", "red_nether_brick", "end_brick", "prismarine" };
