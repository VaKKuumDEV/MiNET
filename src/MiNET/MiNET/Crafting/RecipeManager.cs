	...
	public class RecipeManager
	{
		...
		static RecipeManager()
		{
			Recipes = new Recipes
			{
				...
				new SmeltingRecipe(new Item(159, 0, 1), new Item(220, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 8, 1), new Item(228, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 7, 1), new Item(227, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 15, 1), new Item(235, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 12, 1), new Item(232, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 14, 1), new Item(234, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 1, 1), new Item(221, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 4, 1), new Item(224, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 5, 1), new Item(225, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 13, 1), new Item(233, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 9, 1), new Item(229, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 3, 1), new Item(223, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 11, 1), new Item(231, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 10, 1), new Item(219, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 2, 1), new Item(222, 0, 1), "furnace"),
				new SmeltingRecipe(new Item(159, 6, 1), new Item(226, 0, 1), "furnace"),
